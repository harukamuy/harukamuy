        ...
        <div style={{ marginBottom: 52 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 12 }}>
            ...
            <div style={{ gridColumn: "span 2", aspectRatio: "2/1", borderRadius: 14, overflow: "hidden" }}>
              <img src="/images/mio-walk.webp" alt="多摩川散歩" width={800} height={400} loading="lazy" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </div>
            {/* ごまもち立ち姿 */}
            <div style={{ aspectRatio: "1", borderRadius: 14, overflow: "hidden" }}>
              <img src="/images/gomamochi-stand.webp" alt="ごまもち" width={400} height={400} loading="lazy" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "top center" }} />
            </div>
            {[
              ...
              <div key={p.src} style={{ aspectRatio: "1", borderRadius: 14, overflow: "hidden" }}>
                <img src={p.src} alt={p.alt} width={400} height={400} loading="lazy" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: p.pos }} />
              </div>
            ))}
          </div>
        </div>
