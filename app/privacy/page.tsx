...
const sections = [
  ...
  {
    title: "3. 広告について",
    body: "当サイトでは、第三者配信の広告サービス（Google AdSense、Amazonアソシエイト、その他アフィリエイトプログラム）を利用する場合があります。広告配信事業者はCookieを使用してユーザーのサイト訪問情報をもとに広告を配信する場合があります。Cookieの使用は各広告配信事業者のプライバシーポリシーに基づきます。",
  },
  {
