...
const timeline = [
  ...
  { year: "2023.3", label: "会社退職・フリーランス転向（31歳）", desc: "8年間勤めた映像プロダクションを退職。退職時の総資産は3,000万円。不安より解放感が大きかった。" },
  { year: "2023", label: "ごまもちをお迎え", desc: "ボストンテリアのごまもちが家族に加わる🐾 一緒に暮らし始めて、毎日がもっと楽しくなった。" },
