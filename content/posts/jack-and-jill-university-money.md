...
<div class="data-card" style="background:#f0f5ee;border:1.5px solid #c8d8c0;border-radius:16px;padding:22px 20px;margin:24px 0;">
  ...
  <div class="keep-grid" style="display:grid;grid-template-columns:auto 1fr 1fr;gap:1px;background:#c8d8c0;border:1px solid #c8d8c0;border-radius:10px;overflow:hidden;font-size:13px;line-height:1.6;min-width:296px;">
    ...
    <div style="background:#fbfdfa;padding:10px 7px;font-weight:700;color:#3a5030;">7%</div>
    <div style="background:#fbfdfa;padding:10px 7px;color:#3a5030;text-align:center;">約5,700万円</div>
    <div style="background:#fbfdfa;padding:10px 7px;color:#3a5030;text-align:center;"><strong>約7,400万円 🏆</strong></div>
    <div style="background:#fbfdfa;padding:10px 7px;font-weight:700;color:#3a5030;">10%</div>
    <div style="background:#fff6ea;padding:10px 7px;color:#a85f3c;text-align:center;"><strong>約1.9億円 🏆</strong></div>
    <div style="background:#fbfdfa;padding:10px 7px;color:#3a5030;text-align:center;">約1.8億円</div>
  </div>
  </div>
...
<div class="data-card" style="background:#f0f5ee;border:1.5px solid #c8d8c0;border-radius:16px;padding:22px 20px;margin:24px 0;">
  ...
  <div class="keep-grid" style="display:grid;grid-template-columns:auto 1fr 1fr;gap:1px;background:#c8d8c0;border:1px solid #c8d8c0;border-radius:10px;overflow:hidden;font-size:13px;line-height:1.6;min-width:296px;">
    ...
    <div style="background:#fbfdfa;padding:10px 7px;font-weight:700;color:#3a5030;">3%</div>
    <div style="background:#fbfdfa;padding:10px 7px;color:#3a5030;text-align:center;">約3,200万円</div>
    <div style="background:#fbfdfa;padding:10px 7px;color:#3a5030;text-align:center;"><strong>約3,600万円 🏆</strong></div>
    <div style="background:#fbfdfa;padding:10px 7px;font-weight:700;color:#3a5030;">5%</div>
    <div style="background:#fff6ea;padding:10px 7px;color:#a85f3c;text-align:center;"><strong>約7,500万円 🏆</strong></div>
    <div style="background:#fbfdfa;padding:10px 7px;color:#3a5030;text-align:center;">約6,000万円</div>
    <div style="background:#fbfdfa;padding:10px 7px;font-weight:700;color:#3a5030;">7%</div>
    <div style="background:#fff6ea;padding:10px 7px;color:#a85f3c;text-align:center;"><strong>約1.8億円 🏆</strong></div>
    <div style="background:#fbfdfa;padding:10px 7px;color:#3a5030;text-align:center;">約1.1億円</div>
  </div>
  </div>
...
amazon: 4866511249
description: ジャックとジルと同じで、寓話の形でお金の原則を教えてくれる一冊。「収入の10分の1を先に取り分ける」という100年前から変わらない教えが軸になっていて、漫画なので一気に読めます。貯める力を身につける入口として、いちばん薦めやすい本だと思っています。
:::
...
<li>ジャックとジルは、複利の力を伝えるたとえ話。8年しか積み立てないジルが、38年積み立てたジャックに高利回りだと勝ってしまう</li>
<li>ただし勝敗は利回りしだいで入れ替わる。最強は「早く始めて、長く続ける」の両取り</li>
<li>条件を自由に変えられる<a href="/tools/jack-and-jill">シミュレーター</a>をブログ内に作った。自分の数字で試せる</li>
<li>「大学に行くのは収入のため」を検証。学費410万円を18歳で投資に回したジルは、利回り3.7%を超えると大卒のジャックに勝つ</li>
<li>ただしジャックには、大卒の生涯賃金差（約5,000万〜6,000万）がまるごと残っている。人生の収支は、投資だけでは決まらない</li>
<li>本当の教訓は「18歳のお金と時間には、すごく価値がある」。いちばん高くつくのは、目的を持たないままどちらかを選ぶこと</li>
