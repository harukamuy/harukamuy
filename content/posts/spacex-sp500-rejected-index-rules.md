...
額面どおりに見ても数%、実際に効く浮動株ベースなら1%にも満たない。それも指数全体の話で、**わたしの資産5,806万円に占める比率となると、やっぱり誤差の範囲** だ。つまり「S&P500に入れる・入れない」というニュースは、正直なところわたしの家計にはほとんど影響がない。だから今回も、投資行動は何ひとつ変えない。オルカンを、これまで通り淡々と積み立てるだけだ。
