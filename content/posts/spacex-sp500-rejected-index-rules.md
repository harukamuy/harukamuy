---
title: "スペースX、S&P500は門前払い・でもQQQには入れる?——指数会社で割れた判断を調べてみた"
date: "2026-06-15"
updated: "2026-06-30"
category: "news"
...
<div class="turn dog">
  ...
  <div class="bubble-wrap">
    ...
    <div class="bubble">
      まえに「スペースXはいつS&P500に入るの?」ってやってたよね🐾
    </div>
  </div>
</div>
...
<div class="turn mio">
  ...
  <div class="bubble-wrap">
    ...
    <div class="bubble">
      そう。調べてたら、実はルール変更が検討されてたんだって。でも結局S&P500は「入れない」って決めたの。
    </div>
  </div>
</div>
...
前に [スペースX上場。オルカン・QQQ・S&P500にはいつ入る?](/blog/spacex-ipo-index-inclusion) という記事を書いた。指数の組み入れルールを調べたら意外と面白かった、という話。
...
<div class="data-card" style="background:#f0f5ee;border:1.5px solid #c8d8c0;border-radius:16px;padding:22px 20px;margin:24px 0;">
<div style="font-size:13px;font-weight:700;color:#4a6640;margin-bottom:14px;">🏛 S&P と S&P500 の関係</div>
<div style="display:flex;flex-direction:column;gap:10px;font-size:13px;color:#3a5030;">
<div style="display:flex;gap:10px;align-items:flex-start;"><span style="color:#5a8a50;font-weight:700;flex-shrink:0;">S&P</span><span><strong>スタンダード・アンド・プアーズ(Standard & Poor's)</strong>の略。19世紀から続く米国の金融情報サービスの名門で、企業の格付けや株価指数で有名。現在の指数事業は <strong>S&Pダウ・ジョーンズ・インデックス社</strong> が担う(指数の"胴元")</span></div>
<div style="display:flex;gap:10px;align-items:flex-start;"><span style="color:#5a8a50;font-weight:700;flex-shrink:0;">S&P500</span><span>そのS&Pが算出している、<strong>米国の代表的な大型企業500社の株価指数</strong>。eMAXIS SlimやSBI・VのS&P500もこれに連動している</span></div>
<div style="display:flex;gap:10px;align-items:flex-start;"><span style="color:#5a8a50;font-weight:700;flex-shrink:0;">採用ルール</span><span>どの会社を500社に入れるか/外すかは、<strong>S&Pが決めた基準</strong>に従って決まる。今回はこの「基準」を変えるかどうかが論点になった</span></div>
</div>
</div>
...
- **直近四半期がGAAP基準で黒字**であること
- かつ **直近4四半期の合計も黒字**であること
- さらに **上場から12ヶ月以上**経っていること
...
<div class="data-card" style="background:#f0f5ee;border:1.5px solid #c8d8c0;border-radius:16px;padding:22px 20px;margin:24px 0;">
<div style="font-size:13px;font-weight:700;color:#4a6640;margin-bottom:14px;">🚀 スペースXの2025年実績</div>
<div style="display:flex;flex-direction:column;gap:10px;font-size:13px;color:#3a5030;">
<div style="display:flex;gap:10px;align-items:flex-start;"><span style="color:#5a8a50;font-weight:700;flex-shrink:0;">売上高</span><span><strong>約186億7,000万ドル</strong>(前年比+33%の急成長)</span></div>
<div style="display:flex;gap:10px;align-items:flex-start;"><span style="color:#5a8a50;font-weight:700;flex-shrink:0;">純損益</span><span><strong>約49億4,000万ドルの「純損失」</strong></span></div>
</div>
</div>
...
<div class="turn mio">
  ...
  <div class="bubble-wrap">
    <div class="speaker-label">あずき</div>
    <div class="bubble">
      そう、「大きい」と「儲かってる」は別なんだよ。S&P500は後者を見るの。
    </div>
  </div>
</div>
...
[わたしがQQQを買わない理由](/blog/qqq-tosho-listing-not-buying) で書いた「QQQはテック濃度が高い」という話とも、ここでつながってくる。**QQQはこういう"未来に賭ける"銘柄を早めに取り込む指数** なんだな、と改めて納得した。
...
<div class="turn mio">
  ...
  <div class="bubble-wrap">
    <div class="speaker-label">あずき</div>
    <div class="bubble">
      門番(指数会社)によってルールが違うんだよ。同じ会社でも扱いが変わるの。
    </div>
  </div>
</div>
...
> ルールを緩めて得をするのは、早く指数入りしたい企業(と既存株主)。
> 損をするかもしれないのは、それを自動で買わされるインデックス投資家。
...
<div class="data-card" style="background:#f0f5ee;border:1.5px solid #c8d8c0;border-radius:16px;padding:22px 20px;margin:24px 0;">
<div style="font-size:13px;font-weight:700;color:#4a6640;margin-bottom:14px;">📜 指数ルール改定の代表例</div>
<div style="display:flex;flex-direction:column;gap:12px;font-size:13px;color:#3a5030;">
<div style="display:flex;gap:10px;align-items:flex-start;"><span style="color:#5a8a50;font-weight:700;flex-shrink:0;">S&P500・<br/>2017年</span><span><strong>議決権のない株式しか公開していない企業を新規採用の対象外に</strong>。スナップ(Snapchatの会社)が「議決権ゼロの株」だけを上場したのが引き金。インデックス投資家が議決権のない株を強制的に買わされるのを防ぐための改定</span></div>
<div style="display:flex;gap:10px;align-items:flex-start;"><span style="color:#5a8a50;font-weight:700;flex-shrink:0;">日経平均・<br/>2021年</span><span><strong>「株価換算係数」を導入</strong>。それまでは値がさ株(株価が高い株)の影響が過大になりやすかったのを、調整係数で補正するように変更</span></div>
<div style="display:flex;gap:10px;align-items:flex-start;"><span style="color:#5a8a50;font-weight:700;flex-shrink:0;">日経平均・<br/>2022〜24年</span><span><strong>1銘柄の比率上限(キャップ)を段階的に導入</strong>(12%→11%→10%)。2024年にファーストリテイリングが初めてこの上限に引っかかり、係数が調整された</span></div>
<div style="display:flex;gap:10px;align-items:flex-start;"><span style="color:#5a8a50;font-weight:700;flex-shrink:0;">NASDAQ100・<br/>2026年</span><span><strong>大型IPOの「ファスト・エントリー」新設</strong>。スペースXのような超大型新規上場を早く取り込めるようルールを変更(今回S&Pが見送ったのと逆方向の判断)</span></div>
</div>
</div>

こうして見ると、**指数は「一度決めたら固定」ではなく、市場の変化に合わせて中身もルールも更新されていくもの** だとわかる。1社の比率が大きくなりすぎたら上限をかけ、新しいタイプの巨大企業が出てきたら取り込み方を考える——その積み重ねが、指数の信頼性を保っている。
...
<div class="data-card" style="background:#f0f5ee;border:1.5px solid #c8d8c0;border-radius:16px;padding:22px 20px;margin:24px 0;">
<div style="font-size:13px;font-weight:700;color:#4a6640;margin-bottom:14px;">📅 スペースXのS&P500入りの条件(現行ルール)</div>
<div style="display:flex;flex-direction:column;gap:10px;font-size:13px;color:#3a5030;">
<div style="display:flex;gap:10px;align-items:flex-start;"><span style="color:#5a8a50;font-weight:700;flex-shrink:0;">①</span><span>上場してから<strong>12ヶ月以上</strong>が経過している</span></div>
<div style="display:flex;gap:10px;align-items:flex-start;"><span style="color:#5a8a50;font-weight:700;flex-shrink:0;">②</span><span><strong>直近四半期+直近4四半期の合計</strong>がGAAP黒字になっている</span></div>
<div style="display:flex;gap:10px;align-items:flex-start;"><span style="color:#5a8a50;font-weight:700;flex-shrink:0;">③</span><span>その他の流動性・浮動株などの基準も満たす</span></div>
</div>
</div>
...
一方で、[前回の記事](/blog/spacex-ipo-index-inclusion) で書いた通り、**オルカン(MSCI ACWI)は6月下旬、QQQ(NASDAQ100)は7月上旬** にはスペースXが組み入れられる見込み。S&P500だけが何年も遅れる、という構図になっている。オルカンやQQQを持っている人は、**この夏にはもうスペースXを(ほんの少しだけど)持つことになるかもしれない**。
...
<div class="data-card" style="background:#f0f5ee;border:1.5px solid #c8d8c0;border-radius:16px;padding:22px 20px;margin:24px 0;">
<div style="font-size:13px;font-weight:700;color:#4a6640;margin-bottom:14px;">💡 この騒動から学べる3つのこと</div>
<div style="display:flex;flex-direction:column;gap:12px;font-size:13px;color:#3a5030;">
<div style="display:flex;gap:10px;align-items:flex-start;"><span style="color:#5a8a50;font-weight:700;flex-shrink:0;">①</span><span><strong>「大きい」と「儲かってる」は別物</strong>。S&P500は規模より収益性を見る。だからこそ"優良企業の集まり"という信頼が保たれている</span></div>
<div style="display:flex;gap:10px;align-items:flex-start;"><span style="color:#5a8a50;font-weight:700;flex-shrink:0;">②</span><span><strong>同じ会社でも指数によって扱いが違う</strong>。S&P500・QQQ・オルカン、どれを持つかで"何に投資しているか"が変わる</span></div>
<div style="display:flex;gap:10px;align-items:flex-start;"><span style="color:#5a8a50;font-weight:700;flex-shrink:0;">③</span><span><strong>指数のルールは、わたしたちのお金の行き先を決めている</strong>。インデックス投資は「お任せ」だけど、その"お任せ先のルール"は本当は知っておくべきなのかも(わたしは知らなかったけど 笑。大事なお金だしね)</span></div>
</div>
</div>

### わたしの場合、どう判断したか

最後に、この件を自分のお金にあてはめて考えてみる。わたしの総資産は約5,806万円(2026年5月末時点)。そのうち **インデックス(オルカン・S&P500・iDeCo)が約3,823万円で、全体の約66%** を占めている。

仮にスペースXがこの先S&P500やオルカンに組み入れられたとしても、それは500社・約3,000社のうちの「1社」。実際にどれくらいの比率になるのか、評価額からざっくり計算してみた。

<div class="data-card" style="background:#f0f5ee;border:1.5px solid #c8d8c0;border-radius:16px;padding:22px 20px;margin:24px 0;">
<div style="font-size:13px;font-weight:700;color:#4a6640;margin-bottom:14px;">🔢 スペースXは指数の何%を占める?(概算)</div>
<div style="display:flex;flex-direction:column;gap:10px;font-size:13px;color:#3a5030;margin-bottom:16px;">
...
額面どおりに見ても数%、実際に効く浮動株ベースなら1%にも満たない。それも指数全体の話で、**わたしの資産5,806万円に占める比率となると、やっぱり誤差の範囲** だ。つまり「S&P500に入れる・入れない」というニュースは、正直なところわたしの家計にはほとんど影響がない。だから今回も、投資行動は何ひとつ変えない。オルカンとS&P500を、これまで通り淡々と積み立てるだけだ。

ただ、まったくのノーチェックでいいとも思っていない。今回くらいの変更なら気にしなくていいけれど、**指数のルールがどう動くかは、ゆるく情報を追っておくくらいはしておきたい**。もし将来、可能性は低いと思うけど"大きな改悪"があれば、おそらくSNSや投資界隈がざわつくはず。そのときは、**自分の持っている指数を改めて見直すことも検討する** かもしれない。とはいえ今回、S&Pはむしろルールを"守った"。つまり、**いまのわたしがやることは何もない**。これが結論だ。

そのうえで、**「自分が持っている指数が、どういうルールで中身を決めているか」を知っておく** のは、ただの雑学以上の意味がある。お任せ投資ほど、お任せ先の仕組みを少し知っておくと、いざというときに **航路を守る手助けをしてくれるような気がする**。今回もいい勉強になった。
...
「指数のルールを調べてみた」シリーズ、第2弾でした。前回の [スペースX上場・指数組み入れの基本](/blog/spacex-ipo-index-inclusion) とあわせてどうぞ。
...
この記事はあずき個人の見解・体験のシェアです。特定の銘柄・金融商品への投資を推奨・勧誘するものではありません。掲載している数字は執筆時点の公開情報(各種報道)をもとにしていますが、正確性を保証するものではなく、今後変動する可能性があります。投資は価格が変動し、元本を割り込む可能性があります。必ずご自身の判断と責任で行ってください。
</div>

## 関連記事

- [スペースX上場。オルカン・QQQ・S&P500にはいつ入る?](/blog/spacex-ipo-index-inclusion)
- [世界最大級ETF『QQQ』が東証上場。でもわたしは買わない理由](/blog/qqq-tosho-listing-not-buying)
- [オルカン vs S&P500——両方積み立てているわたしの結論](/blog/orukan-vs-sp500-real)
- [日経平均6万円時代——貯金では追いつかない現実](/blog/nikkei-60000-investment-now)

:::cta
title: SBI証券 — オルカン・S&P500・米国株までこれ1つ
description: つみたて投資枠でオルカン・S&P500、成長投資枠で米国株や東証ETFまで幅広く対応。買付手数料無料で、指数連動の投信もシンプルに積み立てられる。わたしのメイン口座として8年以上愛用中。
