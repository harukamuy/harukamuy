...
<div class="data-card" style="background:#f0f5ee;border:1.5px solid #c8d8c0;border-radius:16px;padding:22px 20px;margin:24px 0;">
  ...
  <div style="display:flex;flex-direction:column;gap:8px;font-size:13px;color:#3a5030;">
    ...
    <div style="display:flex;justify-content:space-between;gap:8px;"><span>米国ETF（BNDなど）</span><span>19.8%</span></div>
    <div style="display:flex;justify-content:space-between;gap:8px;"><span>卸売業</span><span>9.2%</span></div>
    <div style="display:flex;justify-content:space-between;gap:8px;"><span>化学</span><span>7.6%</span></div>
    <div style="display:flex;justify-content:space-between;gap:8px;"><span>情報・通信業</span><span>7.3%</span></div>
    <div style="display:flex;justify-content:space-between;gap:8px;"><span>建設業</span><span>5.0%</span></div>
    <div style="display:flex;justify-content:space-between;gap:8px;"><span>サービス業</span><span>4.9%</span></div>
    <div style="display:flex;justify-content:space-between;gap:8px;"><span>輸送用機器</span><span>4.4%</span></div>
    <div style="display:flex;justify-content:space-between;gap:8px;"><span>電気機器</span><span>4.3%</span></div>
    <div style="display:flex;justify-content:space-between;gap:8px;"><span>その他製品</span><span>3.6%</span></div>
    <div style="display:flex;justify-content:space-between;gap:8px;"><span>ETF・他</span><span>3.5%</span></div>
    <div style="display:flex;justify-content:space-between;gap:8px;"><span>機械</span><span>3.5%</span></div>
    <div style="display:flex;justify-content:space-between;gap:8px;"><span>食料品</span><span>3.1%</span></div>
    <div style="display:flex;justify-content:space-between;gap:8px;"><span>医薬品</span><span>2.8%</span></div>
    <div style="display:flex;justify-content:space-between;gap:8px;"><span>空運業</span><span>2.2%</span></div>
    <div style="display:flex;justify-content:space-between;gap:8px;"><span>倉庫・運輸関連業</span><span>2.0%</span></div>
    <div style="display:flex;justify-content:space-between;gap:8px;padding-top:6px;border-top:1px solid #c8d8c0;color:#4a6640;"><span>その他（保険業・銀行業・不動産業など）</span><span>16.8%</span></div>
  </div>
</div>
