...
<div class="data-card" style="background:#f0f5ee;border:1.5px solid #c8d8c0;border-radius:16px;padding:22px 20px;margin:24px 0;">
  ...
  <div style="font-size:11px;color:#5a8a50;margin-top:12px;border-top:1px dashed #c8d8c0;padding-top:10px;">直近242営業日（約1年）の日次データから計算。配当は含まず、値動きだけを見ています。計算に使う日数を変えると、数字も少し変わります</div>
</div>
...
これを機に、少しずつ直していきたい。ただし[売らない方針](/blog/high-dividend-exit-strategy)は変えないので、やり方は<strong>比率の小さい銘柄を買い足していく</strong>形だけだ。しかも高配当株は、<strong>利回りが見合う価格に下がったとき</strong>しか買えない。<strong>何年もかかるかもしれないけれど、それでかまわない</strong>と思っている。
...
<strong>自分ではもっとリスクを取っているつもりでいた</strong>。個別株を117銘柄も持っているのだから、インデックスよりずっと荒いものだろう、と勝手に思っていた。
